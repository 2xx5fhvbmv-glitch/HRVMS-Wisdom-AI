...
return [
    ...
    'national' => [
        ...
        ['code' => 'HAQ', 'name' => 'Hanimaadhoo International Airport', 'city' => 'Hanimaadhoo'],
        ['code' => 'VAM', 'name' => 'Maafaru International Airport', 'city' => 'Maafaru'],
        ['code' => 'FVM', 'name' => 'Fuvahmulah Airport', 'city' => 'Fuvahmulah'],
        ['code' => 'KDM', 'name' => 'Kaadedhdhoo Airport', 'city' => 'Kaadedhdhoo'],
        ['code' => 'KDO', 'name' => 'Kadhdhoo Airport', 'city' => 'Kadhdhoo'],
        ['code' => 'DRV', 'name' => 'Dharavandhoo Airport', 'city' => 'Dharavandhoo'],
        ['code' => 'TMF', 'name' => 'Thimarafushi Airport', 'city' => 'Thimarafushi'],
        ['code' => 'IFU', 'name' => 'Ifuru Airport', 'city' => 'Ifuru'],
        ['code' => 'VRG', 'name' => 'Villa International Airport Maamigili', 'city' => 'Maamigili'],
        ['code' => 'GKK', 'name' => 'Kooddoo Airport', 'city' => 'Kooddoo'],
        ['code' => 'NMF', 'name' => 'Maafaru', 'city' => 'Maafaru'],
    ],
