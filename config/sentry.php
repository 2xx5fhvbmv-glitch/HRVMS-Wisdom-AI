...
return [
    ...
    // server, which also runs with APP_ENV=production) — events are tagged
    // with the environment below so the two are distinguishable in Sentry.
    'dsn' => in_array(env('APP_ENV'), ['local', 'production'], true)
