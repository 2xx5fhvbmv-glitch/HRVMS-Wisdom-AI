...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Read-only connection used ONLY by the Wisdom AI ad-hoc query tool.
        // Defaults to the main DB credentials, but for true defense-in-depth
        // point DB_READONLY_USERNAME/PASSWORD at a MySQL user granted SELECT only
        // (GRANT SELECT ON <db>.* TO 'wisdom_ro'@'%';). The application-level
        // guard (ReadQueryGuard) is the primary protection regardless.
        'mysql_readonly' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'forge'),
            'username' => env('DB_READONLY_USERNAME', env('DB_USERNAME', 'forge')),
