...
<div class="accordion mb-2 position-accordion" id="<?php echo e($accordionId); ?>">
    <div class="accordion-item">
        <h2 class="accordion-header" id="heading<?php echo e($accordionId); ?>">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collapse<?php echo e($accordionId); ?>" aria-expanded="false"
                    aria-controls="collapse<?php echo e($accordionId); ?>">
                <i class="fas fa-user-tie me-2"></i>
                <span><?php echo e($positionName); ?></span>
                <span class="badge badge-info ms-2 small">Filled: <?php echo e($positionData['max_counts']['max_filledcount']); ?></span>
                <span class="badge badge-warning ms-1 small">Vacant: <?php echo e($positionData['max_counts']['max_vacantcount']); ?></span>
                <span class="badge badge-dark ms-2 small positionGrandTotal">Budget: $<?php echo e(number_format($positionGrandTotal ?? 0, 2)); ?></span>
            </button>
        </h2>

        <div id="collapse<?php echo e($accordionId); ?>" class="accordion-collapse collapse"
             aria-labelledby="heading<?php echo e($accordionId); ?>">
                        ...
                        <thead class="table-light">
                            <tr>
                                ...
                                <?php $__currentLoopData = $header; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th class="text-nowrap text-end scrollable-col"><?php echo e($h); ?></th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tr>
                        </thead>
                        <tbody>
                            
                            <?php if(!empty($positionData['employees']) && count($positionData['employees']) > 0): ?>
                                <?php $__currentLoopData = $positionData['employees']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    ?>
                                    <tr data-row-id="employee-<?php echo e($employee->emp_id); ?>">
                                        <td class="sticky-col sticky-col-1"><?php echo e(ucwords(($employee->first_name ?? '') . ' ' . ($employee->last_name ?? ''))); ?></td>
                                        ...
                                        <td class="sticky-col sticky-col-3">
                                            ...
                                            ?>
                                            <?php echo e($AvailableRank); ?>

                                        </td>
                                        <td class="sticky-col sticky-col-4"><?php echo e($employee->nationality ?? '-'); ?></td>
                                        <td class="text-end sticky-col sticky-col-5 basic-salary-cell" data-value="<?php echo e($displayBasicSalary); ?>">$<?php echo e(number_format($displayBasicSalary, 2)); ?></td>
                                        <td class="text-end sticky-col sticky-col-6 current-salary-cell" data-value="<?php echo e($displayCurrentSalary); ?>">$<?php echo e(number_format($displayCurrentSalary, 2)); ?></td>
                                        <?php $__currentLoopData = $resortCosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            <td class="text-end scrollable-col cost-cell"
                                                data-cost-id="<?php echo e($cost->id); ?>"
                                                data-value="<?php echo e($costValue); ?>"
                                                data-currency="<?php echo e($costCurrency); ?>"><?php echo e($displaySymbol); ?><?php echo e(number_format($displayValue, 2)); ?></td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($positionData['max_counts']['max_vacantcount'] > 0): ?>
                                <?php for($i = 1; $i <= $positionData['max_counts']['max_vacantcount']; $i++): ?>
                                    <?php
                                        // Get MVR to Dollar conversion rate
                                        $mvrToDollarRate = 1/15.42; // Default value (1 MVR = 1/15.42 USD)
                                        $resortSettings = \App\Models\ResortSiteSettings::where('resort_id', auth()->guard('resort-admin')->user()->resort_id)->first();
                                    ...
                                    ?>
                                    <tr data-row-id="vacant-<?php echo e($positionData['position_id']); ?>-<?php echo e($i); ?>">
                                        <td class="text-muted sticky-col sticky-col-1">vacant <?php echo e($i); ?></td>
                                        ...
                                        <td class="text-end sticky-col sticky-col-5 basic-salary-cell <?php echo e($vacantBasicSalary > 0 ? '' : 'text-muted'); ?>" data-value="<?php echo e($vacantBasicSalary); ?>">
                                            $<?php echo e(number_format($vacantBasicSalary, 2)); ?>

                                        </td>
                                        <td class="text-end sticky-col sticky-col-6 current-salary-cell <?php echo e($vacantCurrentSalary > 0 ? '' : 'text-muted'); ?>" data-value="<?php echo e($vacantCurrentSalary); ?>">
                                            $<?php echo e(number_format($vacantCurrentSalary, 2)); ?>
                                        ...
                                        <?php $__currentLoopData = $resortCosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                ...
                                                $displayValue = ($costCurrency === 'MVR') ? $originalValue : $costValue;
                                            ?>
                                            <td class="text-end scrollable-col cost-cell <?php echo e($vacantConfig ? '' : 'text-muted'); ?>"
                                                data-cost-id="<?php echo e($cost->id); ?>"
                                                data-value="<?php echo e($costValue); ?>"
                                                data-currency="<?php echo e($costCurrency); ?>"><?php echo e($displaySymbol); ?><?php echo e(number_format($displayValue, 2)); ?></td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if(empty($positionData['employees']) && $positionData['max_counts']['max_vacantcount'] == 0): ?>
                                <tr>
                                    <td colspan="<?php echo e(count($header) + 6); ?>" class="text-center text-muted py-3">
                            ...
                            <?php if(!empty($positionData['employees']) || $positionData['max_counts']['max_vacantcount'] > 0): ?>
                                ...
                                <tr class="table-secondary fw-bold border-top border-2">
                                    ...
                                    <td class="sticky-col sticky-col-4 text-end"><small><?php echo e($totalRows); ?> Position(s)</small></td>
                                    <td class="text-end sticky-col sticky-col-5 fw-bold">$<?php echo e(number_format($totalBasicSalary, 2)); ?></td>
                                    <td class="text-end sticky-col sticky-col-6 fw-bold">$<?php echo e(number_format($totalCurrentSalary, 2)); ?></td>
                                    <?php $__currentLoopData = $resortCosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td class="text-end scrollable-col fw-bold">$<?php echo e(number_format($costTotals[$cost->id], 2)); ?></td>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tr>
                            <?php endif; ?>
                        </tbody>
...
<?php /**PATH C:\wamp64\www\Wisdom-Ai\HRVMS-Wisdom-AI\resources\views/resorts/renderfiles/position_tree_item.blade.php ENDPATH**/ ?>