...
<body class="hold-transition login-page">
  ...
  <script src="<?php echo e(URL::asset('admin_assets/dist/js/adminlte.min.js')); ?>"></script>
  ...
  <script type="text/javascript">
    $(document).ready( function() {
      ...
      $( "#formLogin" ).on( "submit", function(e) {
        ...
        var url = "<?php echo e(route('admin.login')); ?>";
...
<?php /**PATH C:\wamp64\www\Wisdom-Ai\HRVMS-Wisdom-AI\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>