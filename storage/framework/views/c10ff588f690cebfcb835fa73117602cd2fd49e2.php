                        ...
                        <div class="row g-md-3 g-2 align-items-center">
                            ...
                            <div class="col-xl-2 col-md-4 col-sm-4 col-6">
                                <select class="form-select" name="ResortDivision" id="ResortDivision">
                                    <option ></option>
                                    <?php if($ResortDivision->isNotEmpty()): ?>
                                        <?php $__currentLoopData = $ResortDivision; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
$(document).ready(function() {
    ...
    $(document).on('change', '#department', function() {
        var deptId = $(this).val();
            ...
            $.ajax({
                url: "<?php echo e(route('resort.get.position')); ?>",
                type: "post",
                data: {
                    deptId: deptId
                },
            ...
            $('#ResortInteranlPemissionForm').validate({
                ...
                submitHandler: function(form) {
                    $.ajax({
                        url: "<?php echo e(route('resorts.update_internal_permissions')); ?>", // Ensure route is correct
                        type: "POST",
                        data: $(form).serialize(),
    ...
    $(document).on('keyup', '.searchPermission', function() {
        ...
        $.ajax({
                    url: "<?php echo e(route('resorts.searchPermissions')); ?>", // Ensure route is correct
                    type: "POST",
                    data: {"_token":"<?php echo e(csrf_token()); ?>",SearchValue:$(this).val(),divisionId:divisionId,department:department,position:position},
                    success: function(data) {
                        if (data.success) {
                            if(data.success== true )
                            {
...
$(document).on('change', '#position', function() {
        ...
        $.ajax({
            url: "<?php echo e(route('resort.get.InternalPermissiones')); ?>",
            type: "post",
            data: {
                deptId: Departid,
...
<?php echo $__env->make('resorts.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Wisdom-Ai\HRVMS-Wisdom-AI\resources\views/resorts/Permission/index.blade.php ENDPATH**/ ?>