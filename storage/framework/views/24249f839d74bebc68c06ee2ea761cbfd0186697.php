...
<div class="body-wrapper pb-5">
    <div class="container-fluid">
        ...
        <div class="row g-3 g-xxl-4 card-heigth">
                ...
                <div class="card dashboard-boxcard timeAttend-boxcard">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <strong><?php echo e($EmployeesCount); ?></strong>
                        </div>
                            ...
                            <div class="todoList-block">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="mb-2 small">
                                        ...
                                        <?php elseif($todo->action_type == 'check_out'): ?>
                                            Expected Check-Out: <?php echo e($todo->ExpectedEndTime ?? $todo->EndTime); ?>

                                        <?php elseif($todo->action_type == 'overtime_pending'): ?>
                                            Date: <?php echo e(\Carbon\Carbon::parse($todo->date)->format('d/m/Y')); ?>

                                        <?php endif; ?>
                                    </p>
                                    <?php if($todo->action_type == 'overtime_pending'): ?>
                                        <button type="button" 
                                            class="btn btn-xs btn-warning update-overtime-status" 
                                            data-emp-id="<?php echo e($todo->employee_id); ?>"
                                            data-date="<?php echo e($todo->date); ?>"
            ...
            <div class="col-xl-3 col-lg-6 col-md-6  <?php if(App\Helpers\Common::checkRouteWisePermission('resort.timeandattendance.OverTime',config('settings.resort_permissions.view')) == false): ?> d-none <?php endif; ?>">
...
<script>
    ...
    $("#DashboardDatePicker").on('change', function () {
        ...
        $.ajax({
            url: "<?php echo e(route('resort.timeandattendance.HodDashboardCount', ['date' => '__date__'])); ?>".replace('__date__', date),
            type: "get",
    ...
    function GetAttandance()
    {
        ...
        $.ajax({
            url: "<?php echo e(route('resort.timeandattendance.GetYearWiseAttandanceData', ['year' => '__year__','date' => '__date__'])); ?>".replace('__date__', date).replace('__year__', YearWiseDateattandance),
            type: "get",
            success: function (response) {
    ...
    function GetmyOTHours()
    {
        ...
        $.ajax({
            url: "<?php echo e(route('resort.timeandattendance.MonthOverTimeChart', ['date' => '__date__'])); ?>".replace('__date__', date),
                type: "get",
    ...
    function DutyRosterList()
    {
        ...
        if ($.fn.DataTable.isDataTable('#DutyRoster'))
            ...
            var ajaxUrl = "<?php echo e(route('resort.timeandattendance.DutyRosterdashboardTable')); ?>";
            // #region agent log
...
<?php echo $__env->make('resorts.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Wisdom-Ai\HRVMS-Wisdom-AI\resources\views/resorts/timeandattendance/dashboard/hoddashboard.blade.php ENDPATH**/ ?>