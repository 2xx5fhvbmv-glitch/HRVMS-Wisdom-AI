            ...
            <div>
                <div class="row g-4">
                    <div class="col-lg-6 ">
                        <div class="card mb-30">
                            ...
                            <div class="card-body">
                                ...
                                <form id="exportAttendance" method="POST" action="<?php echo e(route('attendance.export')); ?>" class="mb-4" data-parsley-validate>
                                    <?php echo csrf_field(); ?>
                                ...
                                <form id="ImportAttandanceForm">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-4 mb-3">
                                            <a href="<?php echo e(route('resort.timeandattendance.DownloadAttendanceTemplate')); ?>" class="btn btn-themeSkyblue btn-sm">
                                                Download Template
                                            </a>
                                        </div>
                                        <div class="col-md-4">
                            ...
                            <form>
                                <div class="mb-2">
                                    <select class="form-select  ResortDivision" id="ResortDivision" name='ResortDivision'
                                        ...
                                        <option> </option>
                                        <?php if($resort_divisions->isNotEmpty()): ?>
                                            <?php $__currentLoopData = $resort_divisions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resort_division): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($resort_division->id); ?>"><?php echo e($resort_division->name); ?>
                        ...
                        <div class="card">
                            ...
                            <form id="color-theme-form">
                                ...
                                <div class="row gx-md-4 g-3 mb-3" id="color-theme-container">
                                    <?php if($colorThemes): ?>
                                        <?php $__currentLoopData = $colorThemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $theme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-sm-6 theme-row" data-theme-id="<?php echo e($theme->id); ?>">
                                                <div class="inputCustom-color">
                                                    <input type="text" name="themes[<?php echo e($index); ?>][name]"
                                                        placeholder="Label" class="form-control mb-2"
                                                        value="<?php echo e($theme->name); ?>">
                                                    <input type="color" name="themes[<?php echo e($index); ?>][color]"
                                                        value="<?php echo e($theme->color); ?>" style="top: 28% !important;">
                                                    <button type="button"
                    ...
                    <div class="col-lg-6 ">
                        ...
                        <div class="card mb-30 <?php if(Common::checkRouteWisePermission('resort.upcomingholiday.list',config('settings.resort_permissions.create')) == false): ?> d-none <?php endif; ?>">
                            <div class="card-title">
                                <h3>Public Holidays</h3>
                                <div class="text-end">
                                    <a href="<?php echo e(route('resort.timeandattendance.publicholidaylist')); ?>"
                                        class="a-link">View All</a>
                                </div>
                            </div>
                            <div class="row g-md-3 g-2 align-items-center mb-3">
                                    <div class="col-md-4"><a
                                        href="<?php echo e(URL::asset('resorts_assets/Resort_holiday/ResrortHolidayFormat.xlsx')); ?>"
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" placeholder="Latitude" id="latitude"
                                    value="<?php echo e(isset($ResortGeoLocation) && $ResortGeoLocation->latitude != null ? $ResortGeoLocation->latitude : ''); ?>"
                                    name="latitude">
                            </div>
                            <!-- Longitude Input -->
                            <div class="col-md-12">
                                <input type="text" class="form-control" placeholder="Longitude" id="longitude"
                                    name="longitude"
                                    value="<?php echo e(isset($ResortGeoLocation) && $ResortGeoLocation->longitude != null ? $ResortGeoLocation->longitude : ''); ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-12">
                                <select name="PublicHoliday" id="PublicHoliday" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $PublicHoliday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($p->id); ?>" data-id="<?php echo e($p->id); ?>"
                                            data-date='<?php echo e($p->holiday_date); ?>'><?php echo e($p->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#ImportAttandanceForm').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('resort.timeandattendance.ImportAttandance')); ?>", // Your route for file upload
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
            ...
            $('#fileUploadForm').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('resort.timeandattendance.HolidayfileUpload')); ?>", // Your route for file upload
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
            ...
            $(document).on('change', '.ResortDivision', function() {
                $.ajax({
                    url: "<?php echo e(route('resort.get.ResortDivision')); ?>",
                    type: "post",
                    data: {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        if (id != 0) {
                            ...
                            $.ajax({
                                url: "<?php echo e(route('resort.timeandattendance.removeShift')); ?>",
                                type: "POST",
                                data: {
                                    id: id
            ...
            $("#ShirfFrom").on("submit", function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('resort.timeandattendance.ShiftStore')); ?>",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $('#GeoLocation').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('resort.timeandattendance.GeoFencing')); ?>",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
            ...
            $('#PublicHolidayForm').validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('resort.timeandattendance.ResortHoliday')); ?>",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            container.addEventListener('click', function(e) {
                if (e.target.classList.contains('remove-theme-btn')) {
                    ...
                    if (themeId !== 'new') {
                        ...
                        fetch("<?php echo e(route('colorThemes.delete')); ?>", {
                                method: 'POST',
                                headers: {
            ...
            submitButton.addEventListener('click', function() {
                ...
                fetch("<?php echo e(route('colorThemes.save')); ?>", {
                        method: 'POST',
                        headers: {
...
<?php echo $__env->make('resorts.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Wisdom-Ai\HRVMS-Wisdom-AI\resources\views/resorts/timeandattendance/Configration/index.blade.php ENDPATH**/ ?>