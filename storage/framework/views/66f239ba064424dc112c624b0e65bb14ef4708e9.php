                            ...
                            <div class="col-md-12">
                                <select name="PublicHoliday" id="PublicHoliday" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $PublicHoliday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($p->id); ?>"  data-id="<?php echo e($p->id); ?>" data-date='<?php echo e($p->holiday_date); ?>'><?php echo e($p->name); ?></option>
...
$(document).ready(function() {
    ...
    $('#HolidayList tbody').empty();
        ...
        order:[[4, 'desc']],
        ajax: {
            url: '<?php echo e(route("resort.timeandattendance.publicholidaylist")); ?>',
            type: 'GET',
        },
        columns: [
    ...
    $('#PublicHolidayForm').validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: "<?php echo e(route('resort.timeandattendance.ResortHolidayUpdate')); ?>",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
...
$(document).on("click", ".delete-row-btn", function () {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: "<?php echo e(route('resort.timeandattendance.ResortHolidaydelete')); ?>", // Ensure the route is correctly set
                type: "POST",
                data: {
                    id: id, // Send the ID to delete
                    _token: "<?php echo e(csrf_token()); ?>" // Send CSRF token for security
                },
                success: function(response) {
                    $('#respond-HoldModel').modal('hide');
...
<?php echo $__env->make('resorts.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Wisdom-Ai\HRVMS-Wisdom-AI\resources\views/resorts/timeandattendance/Configration/publicholidaylist.blade.php ENDPATH**/ ?>