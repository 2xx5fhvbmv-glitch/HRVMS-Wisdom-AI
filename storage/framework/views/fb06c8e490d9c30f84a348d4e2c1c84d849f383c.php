                    ...
                    <?php $iteation=1; ?>
                        <?php $__currentLoopData = $MainArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading<?php echo e($iteation); ?>">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapse<?php echo e($iteation); ?>" aria-expanded="true" aria-controls="collapse<?php echo e($iteation); ?>">
                                        <h3><?php echo e($key); ?></h3>
                                        <span class="badge badge-dark">Budget: $ <?php if(array_key_exists($key,$DepartmentTotal)): ?>  <?php echo e($DepartmentTotal[$key]); ?> <?php endif; ?></span>
                                        <a href="#" class="text-lightblue fw-500 fs-13">WSB: $11,985</a>
                                        <!-- <a href="#" class="btn btn-xs btn-coolblue">compare</a> -->
                                    </button>
                                </h2>
                                <div id="collapse<?php echo e($iteation); ?>" class="accordion-collapse collapse <?php echo e(($iteation == 1)  ? 'show':''); ?> " aria-labelledby="heading<?php echo e($iteation); ?>"
            ...
            <form id="ReviseBudget">
                ...
                <div class="modal-body">
                    <div class="form-group mb-20">
                        ...
                        ?>
                        <textarea class="form-control" name="ReviseBudgetComment" id="ReviseBudgetComment" rows="7" placeholder="Add Comment Regarding Revision"><?php echo e($manning_request); ?></textarea>
                    </div>
                </div>
...
<script>
    ...
    ?>
    window.mvrToDollarRate = <?php echo e($mvrToDollarRate); ?>;
    ...
    function fetchConsolidatedBudget(selectedYear) {
        ...
        const resortId = <?php echo json_encode($resortId, 15, 512) ?>; // Ensure this is set correctly
        const url = "<?php echo e(route('resort.budget.viewconsolidated', ':resortId')); ?>".replace(':resortId', resortId);
    ...
    const budgetSaveUrl = '<?php echo e(route("resort.budget.saveCostAssignment", $resortId)); ?>';
    const budgetGetConfigUrl = '<?php echo e(route("resort.budget.getConfiguration", $resortId)); ?>';
...
<?php echo $__env->make('resorts.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Wisdom-Ai\HRVMS-Wisdom-AI\resources\views/resorts/budget/consolidated.blade.php ENDPATH**/ ?>