...
// Route::namespace('API')->group(function () {
	...
	Route::middleware(['auth:api', 'applyResortSmtp'])->group(function () {
		...
		Route::post('resort/profile-signature-preview', [App\Http\Controllers\API\ProfileController::class, 'signaturePreview']);
		Route::post('resort/profile-signature-confirm', [App\Http\Controllers\API\ProfileController::class, 'signatureConfirm']);
		Route::get('resort/profile-signature', [App\Http\Controllers\API\ProfileController::class, 'getSignature']);
		...
		Route::post('chat/read', [App\Http\Controllers\API\ChatBoat\ConversationController::class, 'markThreadRead']);
		Route::post('chat/delivered', [App\Http\Controllers\API\ChatBoat\ConversationController::class, 'markDelivered']);
		Route::get('chat/message-status/{message_id}', [App\Http\Controllers\API\ChatBoat\ConversationController::class, 'messageStatus']);
