    ...
    <script type="text/javascript">
        $(document).ready( function() {
          ...
          $( "#formLogin" ).on( "submit", function(e) {
            ...
            var url = "{{route('shopkeeper.login')}}";
      ...
      <script>
        // Was also storing the plaintext PASSWORD in localStorage — any XSS
        // or shared-browser access could read it directly. Remember-me now
        // only remembers the email; the server-side "remember" cookie
