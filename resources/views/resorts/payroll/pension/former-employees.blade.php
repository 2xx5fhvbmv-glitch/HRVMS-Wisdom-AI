...
@section('content')
    <style>
        #pension-former-hero { padding-bottom: 40px; }
    ...
    <div class="body-wrapper pb-5">
        <div class="container-fluid">
            <div class="page-hedding" id="pension-former-hero">
                <div class="row  g-3">
                    <div class="col-auto">
                    ...
                    <div class="row g-md-3 g-2 align-items-center">
                            ...
                            <div class="dd" data-target="#monthFilter">
                                ...
                                <div class="dd-panel" role="listbox" aria-label="Month">
                                    ...
                                    <div class="dd-scroll">
                                        ...
                                        @for($i = 1; $i <= 12; $i++)
                                        <div class="dd-item" role="option" data-value="{{ $i }}"><span class="dd-nm">{{ date('F', mktime(0,0,0,$i,1)) }}</span><svg class="dd-tick" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M20 6L9 17l-5-5"/></svg></div>
                                        @endfor
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-1 col-md-2 col-sm-3 col-6">
                            ...
                            <div class="dd" data-target="#yearFilter">
                                <button type="button" class="dd-trigger" aria-haspopup="listbox" aria-expanded="false">
                                    <span class="dd-lbl">All Years</span>
                                    <svg class="dd-chev" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
                                </button>
                                <div class="dd-panel" role="listbox" aria-label="Year">
                                    <div class="dd-scroll">
                                        <div class="dd-item active" role="option" data-value=""><span class="dd-nm">All Years</span><svg class="dd-tick" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M20 6L9 17l-5-5"/></svg></div>
                                        @for($y = now()->year; $y >= now()->year - 5; $y--)
