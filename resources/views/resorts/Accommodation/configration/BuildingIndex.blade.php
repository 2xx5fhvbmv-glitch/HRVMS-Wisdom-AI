            ...
            <div class="row g-30">
                ...
                <!-- <div class="col-xxl-6 col-xl-6 col-lg-6"> -->
                    <div class="card">
                        ...
                        <table id="BuildingNameIndex" class="table  w-100">
                            <thead>
                                <tr>
...
<script>
        ...
        var BuildingNameIndex = $('#BuildingNameIndex').DataTable({
            "searching": false,
            "bLengthChange": false,
            "bFilter": true,
            "bInfo": true,
            ...
            serverSide: true,
            order:[[2, 'desc']],
            ajax: '{{ route("resort.accommodation.config.BuildingIndex") }}',
            columns: [
    ...
    $(document).on('click', '.delete-row-btn', function (e) {
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        if (result.success) {
                            ...
                            $('#BuildingNameIndex').DataTable().ajax.reload();
        ...
        $(document).on("click", "#BuildingNameIndex .edit-row-btn", function (event) {
        ...
        $(document).on("click", "#BuildingNameIndex .update-row-btn_cat", function (event) {
            event.preventDefault(); // Prevent default action
            var $row = $(this).closest("tr");
            ...
            $.ajax({
                url: "{{ route('resort.accommodation.BuildingUpdate', '__id__') }}".replace('__id__', CatId),
                type: "PUT",
                data: {
