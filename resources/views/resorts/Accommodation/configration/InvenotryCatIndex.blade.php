            ...
            <div class="row g-30">
                ...
                <!-- <div class="col-xxl-6 col-xl-6 col-lg-6"> -->
                    <div class="card">
                        ...
                        <table id="InvenotryCatIndex" class="table  w-100">
                            <thead>
                                <tr>
...
<script>
        ...
        var InvenotryCatIndex = $('#InvenotryCatIndex').DataTable({
            "searching": false,
            "bLengthChange": false,
            "bFilter": true,
            "bInfo": true,
            ...
            serverSide: true,
            order:[[2, 'desc']],
            ajax: '{{ route("resort.accommodation.config.InvenotryCatIndex") }}',
            columns: [
    ...
    $(document).on('click', '.delete-row-btn', function (e) {
            ...
            wisdomConfirm({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('resort.accommodation.Catdestory', ':id') }}".replace(':id', main_id),
                        dataType: "json",
                        ...
                        if (result.success) {
                            ...
                            $('#InvenotryCatIndex').DataTable().ajax.reload();
        ...
        $(document).on("click", "#InvenotryCatIndex .edit-row-btn", function (event) {
        ...
        $(document).on("click", "#InvenotryCatIndex .update-row-btn_cat", function (event) {
            event.preventDefault(); // Prevent default action
            var $row = $(this).closest("tr");
            ...
            $.ajax({
                url: "{{ route('resort.accommodation.inlineCatUpdate', '__id__') }}".replace('__id__', CatId),
                type: "PUT",
                data: {
