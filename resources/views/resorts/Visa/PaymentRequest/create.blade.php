...
@section('content')
<style>
    #visa-payment-request-create-hero { padding-bottom: 40px; }
    @media (max-width: 575.98px) {
        #visa-payment-request-create-hero { padding-bottom: 0; }
    }
</style>
 <div class="body-wrapper pb-5">
        <div class="container-fluid">
            <div class="page-hedding" id="visa-payment-request-create-hero">
                <div class="row  g-3">
                    <div class="col-auto">
