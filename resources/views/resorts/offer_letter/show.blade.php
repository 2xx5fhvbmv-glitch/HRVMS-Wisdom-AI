    ...
    <div class="invitation-body">
        ...
        @elseif($offer)
            ...
            <div class="text-center mt-3">
                <a href="{{ asset('storage/' . $offer->file_path) }}" download target="_blank" class="download-link">
                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/><path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/></svg>
                    Download Offer Letter
                </a>
                @if($status === 'Sent')
                    <p class="text-muted mt-2" style="font-size:13px;">Please read the offer letter before accepting or declining.</p>
                @endif
            </div>
            @endif
            ...
            @if($status === 'Sent')
                <div class="action-buttons">
                    <form action="{{ route('resort.offer.letter.accept', $token) }}" method="POST" class="loader-form">
                        @csrf
                ...
                <div class="decline-form" id="declineForm">
                    <form action="{{ route('resort.offer.letter.reject', $token) }}" method="POST" class="loader-form">
                        @csrf
                        <div class="mb-3">
