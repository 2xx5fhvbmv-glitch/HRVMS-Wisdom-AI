...
@section('content')
<style>
    #incident-actiontaken-hero { padding-bottom: 40px; }
    @media (max-width: 575.98px) {
        #incident-actiontaken-hero { padding-bottom: 0; }
    }
</style>
<div class="body-wrapper pb-5">
    <div class="container-fluid">
        <div class="page-hedding" id="incident-actiontaken-hero">
...
<script>
    ...
    $(document).on("click", "#IncidentActiontaken .update-row-btn_cat", function (event) {
        ...
        $.ajax({
            url: "{{ route('incident.action-taken.inlineUpdate', '__id__') }}".replace('__id__', Main_id),
            type: "PUT",
            data: {
                Main_id:Main_id,
