...
.dbi-kpi .num{font-size:34px;font-weight:600;letter-spacing:-1px;color:var(--ink);line-height:1}
.dbi-kpi .num small{font-size:13px;font-weight:500;color:var(--faint);letter-spacing:0}
.dbi-kpi .lbl{font-size:12.5px;font-weight:500;color:var(--muted);margin-top:9px}
.dbi-kpi .hint{display:inline-flex;align-items:center;gap:6px;font-size:11.5px;font-weight:500;margin-top:11px}
...
.dbi-card-h .ttl{font-size:13px;font-weight:600;color:var(--ink)}
.dbi-card-h .ttl em{display:block;font-style:normal;font-size:10.5px;font-weight:400;color:var(--faint);margin-top:1px}
.dbi-viewall{font-size:11.5px;font-weight:600;color:var(--teal);text-decoration:none;white-space:nowrap}
.dbi-viewall:hover{text-decoration:underline}
.dbi-viewall-block{display:block;margin-top:4px}
.dbi-sel{font-family:inherit;font-size:11.5px;font-weight:500;color:var(--ink);border:1px solid var(--line);background:var(--neutral-bg);border-radius:8px;padding:5px 9px;cursor:pointer}
...
.dbi-inc .top .t{font-size:13.5px;font-weight:500;color:var(--ink);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
...
.dbi-inc .bot .cat{font-size:11.5px;color:var(--muted);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.dbi-inc .vd{font-size:11.5px;font-weight:600;color:var(--teal);text-decoration:none;white-space:nowrap;flex:none}
...
.dbi-donut .hole b{font-size:24px;font-weight:600;color:var(--ink);letter-spacing:-.5px;line-height:1}
.dbi-donut .hole span{font-size:10px;color:var(--faint);margin-top:3px}
.dbi-legend{flex:1;display:flex;flex-direction:column;gap:11px}
.dbi-legend .lg{display:flex;align-items:center;gap:9px;font-size:12px;color:var(--ink)}
...
.dbi-stat .nm{font-size:12.5px;color:var(--ink)}
...
.dbi-res .l{display:flex;align-items:center;gap:10px;font-size:12.5px;color:var(--ink)}
...
.dbi-res .v{font-size:16px;font-weight:600;color:var(--ink);font-variant-numeric:tabular-nums}
...
.dbi-bars .yax{position:absolute;left:0;top:0;bottom:22px;width:22px;display:flex;flex-direction:column;justify-content:space-between;font-size:9.5px;color:var(--faint);text-align:right}
...
.dbi-bars .col .mn{font-size:10px;color:var(--faint)}
...
.dbi-prev .b .t{font-size:12.5px;font-weight:500;color:var(--ink)}
...
.dbi-pend .t{font-size:12.5px;font-weight:600;color:var(--ink)}
.dbi-pend .s{font-size:11.5px;color:var(--muted);margin-top:3px;line-height:1.5}
...
.dbi-mtg .t{font-size:12.5px;font-weight:600;color:var(--ink)}
.dbi-mtg .s{font-size:11.5px;color:var(--muted);margin-top:3px;line-height:1.5}
...
.dbi-table{width:100%;border-collapse:collapse;font-size:12.5px}
.dbi-table th{text-align:left;font-size:10px;font-weight:600;text-transform:uppercase;letter-spacing:.5px;color:var(--faint);padding:0 0 11px;border-bottom:1px solid var(--line)}
...
.dbi-table .status .none{color:var(--faint);font-size:12px}
...
.dbi-wai-head .wt{font-size:14px;font-weight:600;letter-spacing:-.2px}
.dbi-wai-head .ws{font-size:11px;color:rgba(255,255,255,.9);margin-top:2px}
...
.dbi-wai-item .wtitle{font-size:13px;font-weight:600;color:var(--ink)}
.dbi-wai-item .wdesc{font-size:12px;color:var(--muted);line-height:1.55;margin-top:3px}
.dbi-lnkrow{margin-top:8px}
.dbi-wlink{font-size:11.5px;font-weight:600;color:var(--teal);text-decoration:none;background:none;border:none;padding:0;cursor:pointer;font-family:inherit}
...
.dbi-catrow .nm{font-size:12.5px;color:var(--ink);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.dbi-catrow .val{font-size:13px;font-weight:600;color:var(--ink);font-variant-numeric:tabular-nums;white-space:nowrap;flex:none}
...
.dbi-empty .t{font-size:12.5px;font-weight:500;color:var(--ink)}
