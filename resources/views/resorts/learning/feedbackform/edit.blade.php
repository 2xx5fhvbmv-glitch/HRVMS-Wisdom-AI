...
@section('import-scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            // Custom field templates (star rating + rating table) — mirrors the Performance
            // config editor so saved feedback forms round-trip correctly.
            var templates = {
            ...
            // Initialize FormBuilder with custom field types registered.
