                    ...
                    <div class="card-body">
                        <form id="plFilterForm" class="row g-2 align-items-end mb-3">
                            ...
                            <div class="col-12 d-flex flex-wrap gap-2 align-items-center">
                                <button type="submit" class="btn eb-btn-primary btn-sm" id="plRunBtn">Run Report</button>

                                <div class="dropdown">
                                    <button class="btn eb-btn-accent dropdown-toggle plActionBtn" disabled type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <button type="button" class="btn eb-btn-accent plActionBtn" id="plInsightsBtn" disabled>WAI Insights</button>
                                <button type="button" class="btn eb-btn-secondary d-none" id="plBackToData">Back to Data</button>
                            </div>
                        </form>
