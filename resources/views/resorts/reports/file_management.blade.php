            ...
            <div class="col-lg-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="list-group" id="fmReportList" style="max-height:70vh;overflow:auto">
                    ...
                    <div class="card-body">
                        <form id="fmFilterForm" class="row g-2 align-items-end mb-3">
                            ...
                            <div class="col-12 d-flex flex-wrap gap-2 align-items-center">
                                <button type="submit" class="btn eb-btn-primary btn-sm" id="fmRunBtn">Run Report</button>
                                <div class="dropdown">
                                    <button class="btn eb-btn-accent dropdown-toggle fmActionBtn" disabled type="button" data-bs-toggle="dropdown"><i class="fa fa-download"></i> Export</button>
                                ...
                                <button type="button" class="btn eb-btn-accent fmActionBtn" id="fmInsightsBtn" disabled>WAI Insights</button>
                                <button type="button" class="btn eb-btn-secondary d-none" id="fmBackToData">Back to Data</button>
                            </div>
                        </form>
