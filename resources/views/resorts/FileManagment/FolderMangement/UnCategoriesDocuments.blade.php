...
@section('content')
<style>
    #file-uncategorized-documents-hero { padding-bottom: 40px; }
    @media (max-width: 575.98px) {
        #file-uncategorized-documents-hero { padding-bottom: 0; }
    }
</style>
<div class="body-wrapper pb-5">
   <div class="container-fluid">
      <div class="page-hedding" id="file-uncategorized-documents-hero">
         <div class="row  g-3">
            <div class="col-auto">
                           ...
                           <div class="dd" data-target="#Folderselect">
                               ...
                               <div class="dd-panel" role="listbox" aria-label="Folder">
                                   ...
                                   <div class="dd-scroll">
                                       ...
                                       @if($AllFolderList->isNotEmpty())
                                       @foreach($AllFolderList as $folder)
                                       <div class="dd-item" role="option" data-value="{{ base64_encode($folder->id) }}"><span class="dd-nm">{{ $folder->Folder_Name }}</span><svg class="dd-tick" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M20 6L9 17l-5-5"/></svg></div>
                                       @endforeach
                                       @endif
                                   </div>
                               </div>
