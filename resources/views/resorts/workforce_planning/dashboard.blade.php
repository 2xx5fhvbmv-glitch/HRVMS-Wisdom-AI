        ...
        <div class="row g-4">
            <div class="col-xl-3 col-md-6 order-xl-1 order-2">
                <div class="position-xl-sticky sidebar ">
                    ...
                    <div class="card budget-e-box mb-30 @if(App\Helpers\Common::checkRouteWisePermission('resort.budget.viewbudget', config('settings.resort_permissions.view')) == false)d-none @endif">
                    ...
                    <div class="card  mb-30">
                        ...
                        <div>
                            ...
                            <!-- <div class="d-flex justify-content-between mb-3  pb-2">
                                ...
                                <span class="d-inline-block w-25 text-end text-danger">{{ Common::GetResortCurrencySymbol() }} 0</span>
                            </div> -->
                        </div>
            ...
            <div class="col-xl-6 order-xl-2 order-first">
                <div class="@if(App\Helpers\Common::checkRouteWisePermission('resort.budget.manning', config('settings.resort_permissions.view')) == false) d-none @endif">
                ...
                <div class="@if(App\Helpers\Common::checkRouteWisePermission('resort.budget.consolidatebudget', config('settings.resort_permissions.view')) == false) d-none @endif">
                    <div class="card">
                                ...
                                <table style="width: 100%; border-collapse: collapse;">
                                    <tr>
                                        <td style="padding: 15px;" rowspan="2">
                                            <img src="{{ Common::GetResortLogo($ResortData->id) }}" alt="Logo" style="width: 150px;">
                                        </td>
...
<script type="module">
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: function (tooltipItem) {
                            ...
                            return formatAmount(tooltipItem.raw, 'USD'); // Custom tooltip format
                        }
                    }
                }
            },
    ...
    function fetchAIInsightsData() {
        ...
        $.ajax({
            url: @json(route('resort.workforceplan.dashboard.ai-insights')),
            method: 'GET',
