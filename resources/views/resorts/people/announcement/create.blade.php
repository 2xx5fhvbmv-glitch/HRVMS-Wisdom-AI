...
@section('content')
    <style>
        #announcement-create-hero { padding-bottom: 40px; }
        @media (max-width: 575.98px) {
            #announcement-create-hero { padding-bottom: 0; }
        }
    </style>
    <div class="body-wrapper pb-5">
        <div class="container-fluid">
            <div class="page-hedding" id="announcement-create-hero">
                <div class="row  g-3">
                    <div class="col-auto">
                    ...
                    <div>
                        <div class="row g-md-4 g-3 mb-md-4 mb-3">
                            <div class="col-lg-4 col-sm-6">
                                <label for="announcement_title" class="form-label">Announcement Title <span class="req_span">*</span></label>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <label for="employee_name" class="form-label">Employee Name <span class="req_span">*</span></label>
                            ...
                            <div class="col-12">
                                <label for="congratulatory_message" class="form-label">Congratulatory Message<span class="req_span">*</span></label>
                                <textarea class="form-control" id="congratulatory_message" name="congratulatory_message"
                                    ...
                                    data-parsley-required-message="Please enter congratulatory message"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="card-footer">
                            <div class="row align-items-center g-2">
                                <div class="col-auto">
                                    <a class="a-link" data-action-type="Draft" onclick="submitAnnouncement(this)">Save As Draft</a>
                                </div>
...
<script>
    ...
    function getEmpDetails(empId) {
        if (!empId) return;
        $.ajax({
            url: "{{ route('people.announcements.employee-detail') }}",
            type: "GET",
    ...
    function submitForm() {
        const formData = $("#addAnnouncement").serialize();
        $.ajax({
            url: "{{ route('people.announcements.store') }}",
            type: "POST",
            data: formData,
            success: function (response) {
                if (response.success) {
