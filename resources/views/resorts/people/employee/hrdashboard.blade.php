    ...
    <div class="body-wrapper pb-5">
        <div class="container-fluid">
            ...
            <div class="row g-3 g-xxl-4 card-heigth">
                <div class="col-lg-3 col-sm-6 @if(App\Helpers\Common::checkRouteWisePermission('people.employees',config('settings.resort_permissions.view')) == false) d-none @endif">
                ...
                <div class="col-lg-3 @if(App\Helpers\Common::checkRouteWisePermission('people.employees',config('settings.resort_permissions.view')) == false) d-none @endif">
                    <div class="card">
                ...
                <div class="col-xl-3 col-sm-6 @if(App\Helpers\Common::checkRouteWisePermission('people.employees',config('settings.resort_permissions.view')) == false) d-none @endif">
                    <div class="card">
                        <div class="card-title">
                ...
                <div class="col-lg-6 @if(App\Helpers\Common::checkRouteWisePermission('people.salary-increment.index',config('settings.resort_permissions.view')) == false) d-none @endif">
                ...
                <div class="col-lg-6  @if(App\Helpers\Common::checkRouteWisePermission('people.promotion.dashboard',config('settings.resort_permissions.view')) == false) d-none @endif">
                ...
                <div class="col-lg-6 @if(App\Helpers\Common::checkRouteWisePermission('people.info-update.index',config('settings.resort_permissions.view')) == false) d-none @endif">
                ...
                <div class="col-lg-6 @if(App\Helpers\Common::checkRouteWisePermission('people.probation',config('settings.resort_permissions.view')) == false) d-none @endif">
                ...
                <div class="col-lg-6 @if(App\Helpers\Common::checkRouteWisePermission('people.transfer.initiate',config('settings.resort_permissions.view')) == false) d-none @endif">
                ...
                <div class="col-lg-6 @if(App\Helpers\Common::checkRouteWisePermission('people.advance-salary.index',config('settings.resort_permissions.view')) == false) d-none @endif">
                ...
                <div class="col-lg-3 @if(App\Helpers\Common::checkRouteWisePermission('people.advance-salary-repayment-tracker.index',config('settings.resort_permissions.view')) == false) d-none @endif">
                ...
                <div class="col-lg-9 @if(App\Helpers\Common::checkRouteWisePermission('people.exit-clearance',config('settings.resort_permissions.view')) == false) d-none @endif">
                ...
                <div class="col-lg-3 col-sm-6 @if(App\Helpers\Common::checkRouteWisePermission('people.employee-resignation.index',config('settings.resort_permissions.view')) == false) d-none @endif">
                ...
                <div class="col-lg-6 @if(App\Helpers\Common::checkRouteWisePermission('people.liability.index',config('settings.resort_permissions.view')) == false) d-none @endif">
