...
@section('content')
    <style>
        #onboarding-create-hero { padding-bottom: 40px; }
        @media (max-width: 575.98px) {
            #onboarding-create-hero { padding-bottom: 0; }
        }
    </style>
    <div class="body-wrapper pb-5">
        <div class="container-fluid">
            <div class="page-hedding" id="onboarding-create-hero">
                <div class="row  g-3">
                    <div class="col-auto">
                        ...
                        <div class="mt-2">
                            ...
                            <div class="row g-md-3 g-2 mb-md-4 mb-3">
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    @php $selectedTransportation = $transportations ? ($transportations[optional($lastItinerary)->resort_transportation_id] ?? null) : null; @endphp
                                    ...
                                    <div class="dd" data-target="#resort_transportaion_id">
                                        ...
                                        <div class="dd-panel" role="listbox" aria-label="Resort Transportation">
                                            <div class="dd-scroll">
                                                ...
                                                @if($transportations)
                                                    @foreach($transportations as $key => $value)
                                                        <div class="dd-item{{ optional($lastItinerary)->resort_transportation_id == $key ? ' active' : '' }}" role="option" data-value="{{ $key }}"><span class="dd-nm">{{ $value }}</span><svg class="dd-tick" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M20 6L9 17l-5-5"/></svg></div>
                                                    @endforeach
                                                @endif
                                            </div>
                                        </div>
