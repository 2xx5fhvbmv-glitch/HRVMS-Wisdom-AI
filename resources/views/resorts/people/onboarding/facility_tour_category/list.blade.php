...
@section('content')
    <style>
        #facility-tour-categories-hero { padding-bottom: 40px; }
        @media (max-width: 575.98px) {
            #facility-tour-categories-hero { padding-bottom: 0; }
        }
    </style>
    <div class="body-wrapper pb-5">
        <div class="container-fluid">
            <div class="page-hedding" id="facility-tour-categories-hero">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on("click", ".edit-row-btn", function (event) {
                ...
                // Status options
                let statusOptions = `
                    <select class="form-select status dd-native-select" id="status-${Main_id}">
                    ...
                    <div class="dd" data-target="#status-${Main_id}">
                        <button type="button" class="dd-trigger" aria-haspopup="listbox" aria-expanded="false">
                            <span class="dd-lbl">${statusValue === 'Inactive' ? 'Inactive' : 'Active'}</span>
                            <svg class="dd-chev" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>
                        </button>
                        <div class="dd-panel" role="listbox" aria-label="Status">
                            <div class="dd-scroll">
                                <div class="dd-item ${statusValue === 'Inactive' ? '' : 'active'}" role="option" data-value="Active"><span class="dd-nm">Active</span><svg class="dd-tick" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M20 6L9 17l-5-5"/></svg></div>
                                <div class="dd-item ${statusValue === 'Inactive' ? 'active' : ''}" role="option" data-value="Inactive"><span class="dd-nm">Inactive</span><svg class="dd-tick" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M20 6L9 17l-5-5"/></svg></div>
                            </div>
                        </div>
                    </div>
                `;
