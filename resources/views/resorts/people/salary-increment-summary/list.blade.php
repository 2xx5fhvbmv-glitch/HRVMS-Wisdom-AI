...
@section('content')
<style>
    #salary-increment-summary-hero { padding-bottom: 40px; }
    @media (max-width: 575.98px) {
        #salary-increment-summary-hero { padding-bottom: 0; }
    }
</style>
<div class="body-wrapper pb-5">
      <div class="container-fluid">
            <div class="page-hedding" id="salary-increment-summary-hero">
                 <div class="row  g-3">
                      <div class="col-auto">
         ...
         function loadDataTable() {
                 ...
                 $('#salaryIncrementList').DataTable({
                          ...
                          columns: [
                                 ...
                                 // Use formatAmount() so USD-stored values
                                 // get converted to MVR when the resort
                                 // display currency is MVR (not just the
                                 // symbol swapped).
