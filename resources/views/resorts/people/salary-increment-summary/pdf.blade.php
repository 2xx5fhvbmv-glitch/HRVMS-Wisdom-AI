...
<body>
    ...
    <div class="summary-section">
        <h6>Current Basic Salary (Monthly): <strong>{!! Common::formatCurrency($currentBasicSalary, 'USD') !!}</strong></h6>
        <h6>New Basic Salary (Monthly): <strong>{!! Common::formatCurrency($newBasicSalary, 'USD') !!}</strong></h6>
        <h6>Monthly Payroll Increase: <strong>{!! Common::formatCurrency($monthlyPayrollIncrease, 'USD') !!}</strong></h6>
        <h6>Annual Payroll Increase: <strong>{!! Common::formatCurrency($annualPayrollIncrease, 'USD') !!}</strong></h6>
    </div>
        ...
        <tbody>
            @foreach ($data as $row)
                <tr>
                    ...
                    <td>{!! Common::formatCurrency($row->previous_salary, 'USD') !!}</td>
                    <td>{!! Common::formatCurrency($row->new_salary, 'USD') !!}</td>
                    <td>{!! Common::formatCurrency($row->increment_amount, 'USD') !!}</td>
