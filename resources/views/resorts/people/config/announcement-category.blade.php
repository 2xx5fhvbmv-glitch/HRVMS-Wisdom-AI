...
@section('content')
<style>
    #announcement-category-hero { padding-bottom: 40px; }
    @media (max-width: 575.98px) {
        #announcement-category-hero { padding-bottom: 0; }
    }
</style>
<div class="body-wrapper pb-5">
    <div class="container-fluid">
        <div class="page-hedding" id="announcement-category-hero">
            ...
            <div class="row g-30">
                ...
                <!-- <div class="col-xxl-6 col-xl-6 col-lg-6"> -->
                    <div class="card">
                        ...
                        <table id="AnnouncementCategory" class="table w-100">
                            <thead>
                                <tr>
...
<script>
    ...
    function fecthAnnouncementCategories(){
        ...
        var AnnouncementCategory = $('#AnnouncementCategory').DataTable({
            ...
            serverSide: true,
            order:[[2, 'asc']],
            ajax: '{{ route("announcement.categories") }}',
            columns: [
                { data: 'name', name: 'name', className: 'text-nowrap' }, // Fixed column name
    ...
    $(document).on('click', '.delete-row-btn', function (e) {
        ...
        wisdomConfirm({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('announcement.category.destory', ':id') }}".replace(':id', main_id),
                    dataType: "json",
    ...
    $(document).on("click", "#AnnouncementCategory .edit-row-btn", function (event) {
    ...
    $(document).on("click", "#AnnouncementCategory .update-row-btn_cat", function (event) {
        event.preventDefault(); // Prevent default action
        var $row = $(this).closest("tr");
        var Main_id = $(this).attr('data-cat-id');
