            ...
            <div class="row g-30">
                ...
                <!-- <div class="col-xxl-6 col-xl-6 col-lg-6"> -->
                    <div class="card">
                        ...
                        <table id="IncrementType" class="table w-100">
                            <thead>
                                <tr>
...
<script>
    ...
    function fecth(){
        ...
        var IncrementType = $('#IncrementType').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route("people.increment-types.list") }}',
            columns: [
    ...
    $(document).on('click', '.delete-row-btn', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('people.increment-types.destroy', ':id') }}".replace(':id', main_id),
                    dataType: "json",
    ...
    $(document).on("click", "#IncrementType .edit-row-btn", function (event) {
    ...
    $(document).on("click", "#IncrementType .update-row-btn_cat", function (event) {
        event.preventDefault(); // Prevent default action
        var $row = $(this).closest("tr");
        var Main_id = $(this).attr('data-id');
