                                                            ...
                                                            <table class="table-lableNew w-100">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <th>{{ $position->employees_count }}</th>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                ...
                                                <div class="row g-md-3 g-2 align-items-center">
                                                    <div class="col-sm-6">
                                                        <div class="talentAcqHRStatiEmp-chart">
                                                             <canvas id="myDoughnutChart" data-expatriate_employee ="{{$expatriate_employees_count}}" data-local_employee="{{$local_employees_count}}"></canvas></div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div
                            ...
                            <div class="card card-theme card-talentAcqTimeAttend">
                                <div class="card-title">
                                    <div class="row g-md-2 g-1 align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="{{route('resort.timeandattendance.hoddashboard')}}" class="a-link">View All</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="bg-themeGrayLight">
                                                ...
                                                <div class="leaveUser-main">
                                                    <div class="leaveUser-bgBlock mb-1">
                                                        <h6>Total Hours</h6>
                                                        <strong>{{$totalOverallWorkingHours}}</strong>
                                                    </div>
                                                    <div class="table-responsive mb-md-3 mb-2">
                                                        <table class="table-lableNew w-100">
                                                            <tbody>
                                                                <tr>
                                                                    <td>Normal OT</td>
                                                                    <th>{{$totalNormalWorkingHours}}</th>
                                                                </tr>
                                                                <tr>
                                                                    <td>Holiday OT</td>
                                                                    <th>{{$totalHolidayWorkingHours}}</th>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                    ...
                                                    @foreach($rosterData as $roster)
                                                        ...
                                                        <div class="leaveUser-block">
                                                            <div class="img-circle">
                                                                <img src="{{$roster->profile_picture}}" alt="image">
                                                            </div>
                                                            <div>
                                                                <h6>{{ $roster->first_name }} {{ $roster->last_name }}</h6>
                                                                <span>{{$roster->totalOvertime}} Hours</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                ...
                                                <div id="card-duty">
                                                    <div class=" card-title">
                                                        <div class="row justify-content-between align-items-center g-md-3 g-1">
                                                            ...
                                                            <div class="col-auto"><a href="{{route('resort.timeandattendance.hoddashboard')}}" class="btn btn-themeSkyblue btn-sm">View All</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="card-title">
                                        <div class="row g-2 align-items-center ">
                                            ...
                                            <div class="col-auto"><a href="{{route('GrievanceAndDisciplinery.grivance.GrivanceIndex')}}" class="a-link">View All</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-title">
                                        <div class="row g-2 align-items-center ">
                                            ...
                                            <div class="col-auto"> <a href="{{route('GrievanceAndDisciplinery.Disciplinary.DisciplinaryIndex')}}" class="a-link">View all</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card card-theme card-talentAcqLearningDevel">
                                <div class="card-title">
                                    <div class="row g-md-2 g-1 align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="{{ route('learning.hod.dashboard') }}" class="a-link">View All</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="bg-themeGrayLight">
                                                <div class="card-title">
                                                    <div class="row g-2 align-items-center ">
                                                        ...
                                                        <div class="col-auto"> <a href="{{ route('learning.hod.dashboard')}}" class="a-link">View all</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="leaveUser-main">
                                                    ...
                                                    <table class="table-lableNew table-empLDHod w-100">
                                                        ...
                                                        @foreach($ongoing_tranning as $training)
                                                            <tr>
                                                                <td>
                                                                    <div class="tableUser-block">
                                                                        <div class="img-circle"><img src="{{$training->participant && $training->participant->employee ? App\Helpers\Common::getResortUserPicture($training->participant->employee->Admin_Parent_id) : asset('assets/images/user-2.svg')}}"
                                                                                alt="user">
                                                                        </div>
                                                                        <span class="userApplicants-btn">{{$training->participant && $training->participant->employee ? $training->participant->employee->resortAdmin->full_name : 'N/A'}}</span>
                                                                    </div>
                                                                </td>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="" class="table data-Table  table-peopleProbationList w-100 mb-1">
                                            ...
                                            <tbody>
                                                @foreach($probationEmployees as $probationEmployee)
                                                <tr>
                                                    <td>
                                                        <div class="tableUser-block">
                                                            <div class="img-circle"><img src="{{App\Helpers\Common::getResortUserPicture($probationEmployee->Admin_Parent_id)}}"
                                                                    alt="user">
                                                            </div>
                                                            <span class="userApplicants-btn">{{$probationEmployee->resortAdmin->full_name}}</span>
                                                        </div>
                                                    </td>
                                                    <td>{{$probationEmployee->position->position_title}}</td>
                                ...
                                <div class="card-body">
                                    <div class="row g-md-3 g-2 mb-2">
                                        <div class="col-sm-4">
                                            <div class="bg-themeGrayLight d-flex">
                                                <p>In Progress</p>
                                                <strong>{{$InProgressApplicants}}</strong>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="bg-themeGrayLight d-flex">
                                                <p>Total Applicants</p>
                                                <strong>{{$TotalApplicantCounts}}</strong>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="bg-themeGrayLight d-flex">
                                    ...
                                    <div class="table-responsive">
                                        <table id="" class="table table-talentAcqRecruitment w-100 mb-1">
                                            ...
                                            <tbody>
                                                @if(!$UplcomingApplicants->isEmpty())
                                                    @foreach($UplcomingApplicants as $interview)
                                                    <tr>
                                                        <td>
                                                            <div class="tableUser-block">
                                                                <div class="img-circle"><img src="{{$interview->profileImg}}"
                                                                        alt="user">
                                                                </div>
                                                                <span class="userApplicants-btn">{{$interview->name}}</span>
                                                            </div>
                                                        </td>
                                                        <td>{{$interview->Position}}</td>
                                                        <td>{{$interview->InterViewDate}} - {{$interview->ResortInterviewtime}}</td>
                                                    </tr>
                                                    @endforeach
                                                @else
                                                    <tr>
                            ...
                            <div class="card card-theme">
                                <div class="card-title">
                                    <div class="row g-md-2 g-1 align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="{{route('resort.accommodation.hoddashboard')}}" class="a-link">View All</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table id="" class="table table-talentAcqAccom w-100 mb-1">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="tableUser-block">
                                                            <div class="img-circle"><img src="{{App\Helpers\Common::getResortUserPicture($accommodation->employee->Admin_Parent_id)}}" alt="user">
                                                            </div>
                                                            <span class="userApplicants-btn">{{$accommodation->employee->resortAdmin->full_name}}</span>
                                                        </div>
                                                    </td>
                                                    <td>{{$accommodation->availableAccommodation->building->BuildingName ?? '-'}}</td>

                                                    <td>{{$accommodation->availableAccommodation->Floor ?? '-'}}</td>
                                                    <td>{{$accommodation->availableAccommodation->RoomNo ?? '-'}}</td>
                                                    <td>{{$accommodation->availableAccommodation->BedNo ?? '-'}}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                            ...
                            <div class="card card-theme card-talentAcqPerforHOD h-100">
                                <div class="card-title">
                                    <div class="row g-md-2 g-1 align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="{{ route('Performance.HODdashboard') }}" class="a-link">View All</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                                ...
                                                <div class="bg-themeGrayLight">
                                                    <div class="card-title">
                                                        <div class="row g-md-3 g-1 align-items-center">
                                                            ...
                                                            <div class="col-auto"><a href="{{ route('incident.index')}}" class="a-link">View
                                                                    All</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="leaveUser-main">
                                                        ...
                                                        <div class="leaveUser-block">
                                                            <div>
                                                                ...
                                                                <div>
                                                                    <a href="{{route('incident.view', base64_encode($incident->id))}}" class="eye-btn skyBlue"><i
                                                                            class="fa-regular fa-eye"></i></a>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="card card-theme  h-100">
                                <div class="card-title">
                                    <div class="row g-md-2 g-1 align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="{{ route('people.exit-clearance.index')}}" class="a-link">View All</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="" class="table table-talentAcqExitClear  w-100 mb-1">
                                            ...
                                            <tbody>
                                                @foreach($EmployeeResignation as $resign_employee)
                                                <tr>
                                                    <td>
                                                        <div class="tableUser-block">
                                                            <div class="img-circle"><img src="{{App\Helpers\Common::getResortUserPicture($resign_employee->employee->Admin_Parent_id)}}"
                                                                    alt="user">
                                                            </div>
                                                            <span class="userApplicants-btn">{{$resign_employee->employee->resortAdmin->full_name}}</span>
                                                        </div>
                                                    </td>
                                                    <td>{{$resign_employee->employee->department->name}}</td>
                                                    <td>
                                                        {{ \Carbon\Carbon::parse($resign_employee->last_working_date)->format('d M Y') }} 
                                                          @if(\Carbon\Carbon::parse($resign_employee->last_working_date)->isToday())
                                                            Last Working Day
                                                        @elseif(\Carbon\Carbon::parse($resign_employee->last_working_date)->isFuture())
                                                            (Due in {{ \Carbon\Carbon::parse($resign_employee->last_working_date)->diffForHumans() }})
                       
                                                        @endif</td>
                                                    <td>
                                                        @if($resign_employee->assignedForm->status == 'Pending')
                                                            <span class="badge badge-themeWarning">{{$resign_employee->assignedForm->status}}</span>
                                                        @elseif($resign_employee->assignedForm->status == 'Completed')
                                                            <span class="badge badge-themeSuccess">{{$resign_employee->assignedForm->status}}</span>
                                                        @else
                                                            <span class="badge badge-themeGray">{{$resign_employee->assignedForm->status}}</span>
                                                        @endif
