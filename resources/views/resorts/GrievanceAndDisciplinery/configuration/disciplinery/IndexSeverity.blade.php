...
@section('content')
<style>
    #disciplinary-severity-hero { padding-bottom: 40px; }
    @media (max-width: 575.98px) {
        #disciplinary-severity-hero { padding-bottom: 0; }
    }
</style>

<div class="body-wrapper pb-5">
    <div class="container-fluid">
        <div class="page-hedding" id="disciplinary-severity-hero">
...
<script>
        ...
        $(document).on("click", "#Severity .update-row-btn_cat", function (event) {
            ...
            $.ajax({
                url: "{{ route('GrievanceAndDisciplinery.config.SeverityinlineUpdate', '__id__') }}".replace('__id__', Main_id),
                type: "PUT",
                data: {
                    Main_id:Main_id,
