...
@section('content')
<style>
    #disciplinary-committee-hero { padding-bottom: 40px; }
    @media (max-width: 575.98px) {
        #disciplinary-committee-hero { padding-bottom: 0; }
    }
</style>

<div class="body-wrapper pb-5">
    <div class="container-fluid">
        <div class="page-hedding" id="disciplinary-committee-hero">
...
<script>
        var DisciplineryCategory = $('#IndexAction').DataTable({
            ...
            serverSide: true,
            order:[[4, 'desc']],
            ajax: '{{ route("GrievanceAndDisciplinery.config.IndexDisciplinaryCommittees") }}',
            columns: [
        ...
        $(document).on('click', '.delete-row-btn', function (e) {
            ...
            wisdomConfirm({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('GrievanceAndDisciplinery.config.DisciplinaryCommitteesDestory', ':id') }}".replace(':id', main_id),
                        dataType: "json",
