...
@section('content')
<style>
    #grievance-committee-hero { padding-bottom: 40px; }
    @media (max-width: 575.98px) {
        #grievance-committee-hero { padding-bottom: 0; }
    }
</style>

<div class="body-wrapper pb-5">
    <div class="container-fluid">
        <div class="page-hedding" id="grievance-committee-hero">
...
<script>
        ...
        $(document).on("click", "#IndexAction .update-row-btn_cat", function (event) {
            ...
            $.ajax({
                url: "{{ route('GrievanceAndDisciplinery.config.GrivanceCommitteeinlineUpdate', '__id__') }}".replace('__id__', Main_id),
                type: "PUT",
                data: {
                    Main_id:Main_id,
