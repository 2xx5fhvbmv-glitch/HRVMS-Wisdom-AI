...
@section('content')
<style>
    #grievance-category-index-hero { padding-bottom: 40px; }
    @media (max-width: 575.98px) {
        #grievance-category-index-hero { padding-bottom: 0; }
    }
</style>

<div class="body-wrapper pb-5">
    <div class="container-fluid">
        <div class="page-hedding" id="grievance-category-index-hero">
            ...
            <div class="row g-30">
                ...
                <!-- <div class="col-xxl-6 col-xl-6 col-lg-6"> -->
                    <div class="card">
                        ...
                        <table id="IndexGrievanceCategory" class="table  w-100">
                            <thead>
                                <tr>
...
<script>
        var DisciplineryCategory = $('#IndexGrievanceCategory').DataTable({
            "searching": false,
            "bLengthChange": false,
            "bFilter": true,
            "bInfo": true,
            ...
            serverSide: true,
            order:[[3, 'desc']],
            ajax: '{{ route("GrievanceAndDisciplinery.config.IndexGrievanceCategory") }}',
            columns: [
                { data: 'Category_Name', name: 'Category_Name', className: 'text-nowrap' },
                { data: 'Category_Description', name: 'Category_Description', className: 'text-nowrap' },
        ...
        $(document).on('click', '.delete-row-btn', function (e) {
            ...
            wisdomConfirm({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('GrievanceAndDisciplinery.config.GrievanceCategoryDestory', ':id') }}".replace(':id', main_id),
                        dataType: "json",
                        ...
                        if (result.success) {
                            ...
                            $('#IndexGrievanceCategory').DataTable().ajax.reload();
        ...
        $(document).on("click", "#IndexGrievanceCategory .edit-row-btn", function (event) {
        ...
        $(document).on("click", "#IndexGrievanceCategory .update-row-btn_cat", function (event) {
            event.preventDefault(); // Prevent default action
            var $row = $(this).closest("tr");
            var Main_id = $(this).attr('data-cat-id');
