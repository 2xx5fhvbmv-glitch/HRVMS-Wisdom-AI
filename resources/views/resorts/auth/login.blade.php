...
<body class="login-body">
    <div class="row g-0 h-100">
        ...
        <div class=" col-md-6">
            <div class="login-right">
                <div class="login-form">
                    ...
                    <form name="formLogin" id="formLogin" method="post">
                      ...
                      <div class="row g-md-4 g-3">
                          ...
                          <div class="col-auto ms-auto"><a href="{{route('resort.password.request')}}" class="a-link">Forgot Password?</a></div>
                          <div class="col-12">
                ...
                <div class="footer">© {{ date('Y') }} Wisdom AI Pvt Ltd | Every Data Shielded | Creativity Secured | All
    ...
    <script>
        // Toastr re-theme glue (see toastr-theme.css) — this page is a standalone
        // document (doesn't extend resorts.layouts.app), so it needs its own copy,
        // kept in sync with resorts/layouts/js.blade.php.
    ...
    <script type="text/javascript">
      ...
      <script>
        // Was also storing the plaintext PASSWORD in localStorage — any
        // XSS or shared-browser access could read it directly. Remember-me
        // now only remembers the email; the server-side "remember" cookie
        // (already sent on login) still keeps the session signed in.
        // Proactively purge any password a browser has cached from before
        // this fix, on this and every future visit.
