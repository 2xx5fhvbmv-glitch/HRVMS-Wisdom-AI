...
@section('content')
<style>
    #performance-monthly-checkin-hero { padding-bottom: 40px; }
    @media (max-width: 575.98px) {
        #performance-monthly-checkin-hero { padding-bottom: 0; }
    }
</style>
<div class="body-wrapper pb-5">
        <div class="container-fluid">
            <div class="page-hedding" id="performance-monthly-checkin-hero">
                <div class="row  g-3">
                    <div class="col-auto">
