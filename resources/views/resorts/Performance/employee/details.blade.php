...
@section('content')
    <style>
        #performance-employee-details-hero { padding-bottom: 40px; }
        @media (max-width: 575.98px) {
            #performance-employee-details-hero { padding-bottom: 0; }
        }
    </style>
    <div class="body-wrapper pb-5">
        <div class="container-fluid">
            <div class="page-hedding" id="performance-employee-details-hero">
