            ...
            <div class="row g-3 justify-content-between">
                ...
                <div class="col-auto d-flex gap-2">
                    @if($archivedView ?? false)
                        <a href="{{ route('Performance.pdp.index') }}" class="btn perf-btn-secondary">
                            <i class="fa-solid fa-arrow-left me-1"></i> Active Plans
                        </a>
                    @else
                        <a href="{{ route('Performance.pdp.index', ['archived' => 1]) }}" class="btn perf-btn-secondary">
                            <i class="fa-solid fa-box-archive me-1"></i> View Archived
                        </a>
                        <button type="button" class="btn perf-btn-accent" data-bs-toggle="modal" data-bs-target="#addPdpModal">
