                                                ...
                                                <div class="dd-panel" role="listbox" aria-label="Hiring source year">
                                                    <div class="dd-scroll">
                                                        <div class="dd-item active" role="option" data-value="">
                                                            <span class="dd-nm">Jan 2024 - Dec 2024</span>
                                                        ...
                                                        <div class="dd-item" role="option" data-value="1">
                                                            <span class="dd-nm">Jan 2025 - Dec 2025</span>
                                                            <svg class="dd-tick" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M20 6L9 17l-5-5"/></svg>
                                                        </div>
                                                        <div class="dd-item" role="option" data-value="2">
                                                            <span class="dd-nm">Jan 2026 - Dec 2026</span>
                                                            <svg class="dd-tick" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M20 6L9 17l-5-5"/></svg>
                                                        </div>
                                                    </div>
                                                </div>
...
<script type="text/javascript">
    ...
    $('#respond-dateModal').on('shown.bs.modal', function () {
        ...
        var _pPerf1 = window.WaiChart ? window.WaiChart.palette().card : '#fff';
        // backgroundColor per series: only 2 of 5 (#014653/#2EACB3) match
        // SSOT tokens — left literal as a whole set (no half-themed
        // categorical array). borderColor is the card-background gap
        // between stacked segments, so that alone is themed.
