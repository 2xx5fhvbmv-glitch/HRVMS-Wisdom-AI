        ...
        <div class="modal-content">
            <form id="jobDesEditForm" data-parsley-validate>
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Edit Performance Form</h5>
...
<div class="modal fade" id="FormView-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">View Performance Form</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
    ...
    $(document).on("click", ".view-row-btn", function(){
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                // Build custom HTML for rendering since formRender doesn't support custom templates well
                var html = '';
                ...
                fields.forEach(function(field) {
                    ...
                    if (field.type === 'starRating') {
                        ...
                        // Use formRender for standard fields
