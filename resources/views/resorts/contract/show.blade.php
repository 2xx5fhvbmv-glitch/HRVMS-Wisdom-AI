...
<div class="invitation-card">
    ...
    <div class="invitation-body">
        ...
        @elseif($contract)
            ...
            @php $status = $contract->status; @endphp
            ...
            <div class="text-center mt-3">
                <a href="{{ asset('storage/' . $contract->file_path) }}" download target="_blank" class="download-link">
            ...
            @if($status === 'Sent')
                <div class="action-buttons">
                    ...
                    <button type="button" class="btn-outline-decline" id="showDeclineForm">Decline Contract</button>
                </div>
            ...
            @if($status === 'Rejected' && $contract->rejection_reason)
