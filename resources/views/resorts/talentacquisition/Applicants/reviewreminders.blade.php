...
@section('content')
    <style>
        #ta-review-reminders-hero { padding-bottom: 40px; }
        @media (max-width: 575.98px) {
            #ta-review-reminders-hero { padding-bottom: 0; }
        }
    </style>
    <div class="body-wrapper pb-5">
        <div class="container-fluid">
            <div class="page-hedding page-appHedding" id="ta-review-reminders-hero">
