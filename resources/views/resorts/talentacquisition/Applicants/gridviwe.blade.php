    ...
    @foreach($Applicant_form_data as $a)
        <div class="col-xxl-cust5 col-xl-3 col-lg-4 col-sm-6">
            ...
            @endphp
                ...
                <div>
                    <a href="javascript:void(0)" class="btn ta-btn-secondary btn-sm ApplicantsNotes ApplicantsNotes_{{ $a->applicant_id }}" data-notes="{{ $a->Notes }}"  data-id="{{base64_encode($a->id) }}" data-id="{{ $a->id }}">Notes</a>
                    <a href="javascript:void(0)" class="btn ta-btn-secondary btn-sm userApplicants-btn"  data-id="{{ $a->applicant_id }}">View</a>
                    <a href="javascript:void(0)" class="btn ta-btn-accent btn-sm waiInsightsBtn" data-id="{{ base64_encode($a->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="WAI Insights — CV vs Job Description"><i class="fa-solid fa-robot"></i> WAI CV</a>
                </div>
            </div>
        </div>
    @endforeach
