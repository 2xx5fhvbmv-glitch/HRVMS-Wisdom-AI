        ...
        <div class="talentPoolGrid-block">
            <div class="dropdown table-dropdown ">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li><a class="dropdown-item RejactionReason" data-Rank="{{ $a->As_ApprovedBy }}" data-applicant_status_id="{{ $a->applicant_status_id }}"  data-Comments="{{ $a->Comments }}" href="javascript:Void(0)">Rejection Reason</a></li>
                    <li><a class="dropdown-item destoryApplicant" href="javascript:void(0)"    data-location="{{$a->id}}" data-id="{{ base64_encode($a->id) }}">Delete</a></li>
                </ul>
            </div>
