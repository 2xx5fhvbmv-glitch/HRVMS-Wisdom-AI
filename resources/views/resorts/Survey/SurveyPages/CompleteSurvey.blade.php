...
@section('page_tab_title' ,$page_title)
    ...
    @section('content')
    <style>
        #survey-complete-hero { padding-bottom: 40px; }
        @media (max-width: 575.98px) {
            #survey-complete-hero { padding-bottom: 0; }
        }
    </style>
    <div class="body-wrapper pb-5">
        <div class="container-fluid">
            <div class="page-hedding" id="survey-complete-hero">
...
@endsection
    ...
    $(document).ready(function() {
        ...
        var viewJobDes = $('.table-viewJobDes').DataTable({
            ...
            order:[[7, 'desc']],
            ajax: {
                url: '{{ route("Survey.CompleteSurvey") }}',
                type: 'GET',
                data: function(d)
                {
                    d.search = $('.search').val();
