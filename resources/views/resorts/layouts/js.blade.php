...
<!-- Google Charts -->
<script src="{{ URL::asset('resorts_assets/js/charts-loader.js')}}"></script>
...
<script src="{{ URL::asset('resorts_assets/js/jquery.validate.min.js')}}"></script>
...
<script>
    ...
    function convertAmount(amount, sourceCurrency) {
        ...
        if (displayCurrency !== 'MVR' && sourceCurrency === 'MVR') return amount / usdToMvrRate;
        return amount;
    }
    ...
    $(document).ready( function() {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            $.ajax({
                                url: "{{ route('resort.occupancy.getUpdatedData') }}", // Replace with your route to fetch updated data
                                type: "GET",
            ...
            submitHandler: function(form) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('resort.SendToFinance.manning.notification') }}",
                            type: "POST",
                            data: $(form).serialize(),
                            success: function(response) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            $.ajax({
                                url: "{{ route('resort.occupancy.getUpdatedData') }}",
                                type: "GET",
                                success: function(data) {
                                    let updated = [];
                                    let others = [];
        ...
        $(document).on("click",".notification-box a.profile-dropdown",function(e){
         ...
         $(document).on("click", "#container_menuType", function () {
            ...
            $.ajax({
                url: "{{ route('resort.update.menu-type') }}",
                type: 'POST',
                data: {
                    menuType: menuType,
                    resortid: resortid,
