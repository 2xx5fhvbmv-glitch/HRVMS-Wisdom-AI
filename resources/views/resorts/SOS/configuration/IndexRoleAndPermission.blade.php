...
@section('content')
<style>
    #sos-roles-permission-hero { padding-bottom: 40px; }
    @media (max-width: 575.98px) {
        #sos-roles-permission-hero { padding-bottom: 0; }
    }
</style>

<div class="body-wrapper pb-5">
    <div class="container-fluid">
        <div class="page-hedding" id="sos-roles-permission-hero">
...
<script>
    ...
    $(document).on("click", "#IndexSOSRolesAndPermission .edit-row-btn", function (event) {
        ...
        var editRowHtml = `
            ...
            <td class="py-1">
                <a href="javascript:void(0)" class="btn eb-btn-primary update-row-btn_cat" data-id="${Main_id}">Submit</a>
            </td>`;
