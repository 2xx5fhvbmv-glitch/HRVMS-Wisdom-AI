      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-warning">
            ...
            <div class="card-body">
              <form method="POST" id="frmEditPermissions" class="form-horizontal" action="{{ route('admin.positions.update_permissions',$position->id) }}" >
                @csrf
                <div class="table-responsive">
                  <table id="datatable" class="table table-striped data">
                    <thead>
                      <tr>
                        ...
                        <tr>
                          ...
                          @foreach($permissions as $permission)
                            ...
                            @if($index)
                              <td>
                                <div class="rdio rdio-primary radio-inline">
                                  <input class="form-check-input" id="{{$modulePermissionIds[$module->id][$i]}}" name="module_permissions[]" type="checkbox" value="{{$modulePermissionIds[$module->id][$i]}}" @if(in_array($modulePermissionIds[$module->id][$i],$positionPermissions)) checked  @endif>
