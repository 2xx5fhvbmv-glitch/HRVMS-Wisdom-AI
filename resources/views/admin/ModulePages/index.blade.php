...
<script>
  $(document).ready(function() {
    var url = "{{route('admin.ModulePages.index')}}";
    ...
    $("#all_chk").click(function() {
      if ($(this).is(':checked')) {
        var $view = $('.ModulePages_checkbox').prop("checked", true);
      } else {
        var $view = $('.ModulePages_checkbox').prop("checked", false);
      }
    });

    $(document).on('click', '.ModulePages_checkbox', function() {
      var numberOfChecked = $('.ModulePages_checkbox').filter(':checked').length;
      var totalCheckboxes = $('.ModulePages_checkbox').length;
    ...
    $(document).on('click', '#bulk_delete', function() {
      ...
      $('.ModulePages_checkbox:checked').each(function() {
        id.push($(this).val());
      });
      ...
      if (id.length > 0) {
        swal({
          ...
          if (success) {
            $.ajax({
              url: "{{route('admin.ModulePages.massremove')}}",
              data: {
                id: id
              },
              dataType: "json",
