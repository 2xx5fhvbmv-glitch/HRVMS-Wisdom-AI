...
@section('page_tab_title' ,"Admin Users")
					...
					<div class="card">
						<div class="card-header">
							@if(Common::hasPermission(config('settings.admin_modules.admin_users'),config('settings.permissions.create')))
								<a href="{{route('admin.create')}}" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Add</a>
							@endif
...
<script>
    ...
    $(document).on('click', '.action-delete', function(e) {
	    ...
	    swal({
	    	title: 'Sure want to delete admin?',
