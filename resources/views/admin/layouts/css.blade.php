...
<link rel="stylesheet" href="{{ URL::asset('admin_assets/plugins/jquery-ui/jquery-ui.css') }}">
<link rel="stylesheet" href="{{ URL::asset('admin_assets/plugins/fontawesome-free/css/all.min.css') }}">
<link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
<link rel="stylesheet" href="{{ URL::asset('admin_assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
...
<link rel="stylesheet" href="{{ URL::asset('admin_assets/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
<link rel="stylesheet" href="{{ URL::asset('admin_assets/dist/css/adminlte.min.css') }}">
<link rel="stylesheet" href="{{ URL::asset('admin_assets/dist/css/developer.css') }}">
<link rel="stylesheet" href="{{ URL::asset('admin_assets/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }}">
