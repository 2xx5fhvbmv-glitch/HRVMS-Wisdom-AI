...
@if($isNew == 1)
  @section('page_tab_title' ,"Create Department")
@else
  @section('page_tab_title' ,"Edit Department")
@endif
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="card ">
        ...
        <form method=" post" name="formStore" id="formStore" enctype="multipart/form-data" @if(empty($data->id)) action="{{ route('admin.department.store') }}" @else action="{{ route('admin.department.update', $data->id) }}" @endif >
          @csrf
            ...
            <div class="row">
              <div class="col-sm-6">
                  <div class="form-group">
                      <label for="department">Select Division<span class="red-mark">*</span></label>
                      <select name="division_id" id="division_id" class="form-control select-2-gen" required data-parsley-required-message="Please select a division." data-parsley-errors-container="#div-division_id" >
                          <option value="">Select Division</option>
                          @foreach($divisions as $division)
                              <option value="{{ $division->id }}" 
                                      @if(isset($data->division_id ) && $data->division_id  == $division->id) selected @endif>
                                  {{ $division->name }}
                              </option>
                          @endforeach
                      </select>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Department Code <span class="red-mark">*</span></label>
                  <input 
                    data-parsley-validate-script 
                    data-parsley-validate-script-message="Script tags are not allowed." 
                    data-parsley-errors-container="#div-dept_code" 
                  ...
                  <div id="div-dept_code"></div>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Department Name <span class="red-mark">*</span></label>
                  <input 
                    data-parsley-validate-script 
                    data-parsley-validate-script-message="Script tags are not allowed." 
                    data-parsley-errors-container="#div-dept_name" 
                    ...
                    value="{{ $data->name }}" 
                    title="Only letters and spaces are allowed.">
                  <div id="div-dept_name"></div>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Department Short Name <span class="red-mark">*</span></label>
                  <input 
                    data-parsley-validate-script 
                    data-parsley-validate-script-message="Script tags are not allowed." 
                    data-parsley-errors-container="#div-short_name" 
                    data-parsley-pattern="^[A-Za-z\s\/\(\)\-\_]+$"
                    data-parsley-maxlength="40"
                    data-parsley-maxlength-message="Maximum 40 characters allowed" 
                    required 
