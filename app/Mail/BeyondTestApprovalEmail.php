...
class BeyondTestApprovalEmail extends Mailable
{
    ...
    { 
        ...
        $emailTemplate = EmailTemplate::where('name','=', 'Beyond Test Approval')->first();

        if (!$emailTemplate) {
            $subject = 'Beyond Test Approval with Invoice';
            $body = "<p>[textAboveLink]</p>

            <p>You are receiving this email because your beyond testing is approved by admin. </p>
            
            <p>Here you can check your invoice by clicking on below link</p>
        ...
        $data['downloadPDF'] = route('admin.beyondtesting.quotation', ['id' => $encryptedID]);
        ...
        // dd($data);
        return $this->view('emails.sendBeyondTestInvoice', $data)->subject(Lang::get($subject));
    }
}
