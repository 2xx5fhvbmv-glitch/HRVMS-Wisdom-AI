    ...
    public function createEvent(Request $request)
    {
        ...
        try {
            ...
            foreach ($request->employees as $key => $value) {
                ...
                Common::sendMobileNotification($this->resort_id,2,null,null,$data['title'] .' Event','A new event has been created by ' . $this->user->first_name . ' ' . $this->user->last_name . ' on ' . $data['date'] .  ' at ' . $data['time'] . '.','Calendar',[$value],$event->id,false,'calendar-event-created');
            }
