...
class PromotionReportController extends Controller
{
    ...
    public function promotionRegister(array $f): array
    {
        ...
        $rows = $this->baseQuery($rid, $scoped)
            ...
            ->map(fn($r) => [
                ...
                'Previous Salary'         => $r->current_salary !== null ? Common::formatCurrency($r->current_salary) : 'N/A',
                'New Salary'              => $r->new_salary !== null ? Common::formatCurrency($r->new_salary) : 'N/A',
                'Salary Increase (Amount)' => $r->salary_increment_amount !== null ? Common::formatCurrency($r->salary_increment_amount) : 'N/A',
    ...
    public function promotionExecutiveSummary(array $f): array
    {
        ...
        $rows = [[
            ...
            'Total Salary Impact'               => $totalSalaryImpact !== null ? Common::formatCurrency($totalSalaryImpact) : 'N/A',
