    ...
    public function transferRegister(array $f): array
    {
        ...
        $rows = $this->baseQuery($rid, $scoped)
            ...
            ->map(fn($r) => [
                ...
                'Current Salary'       => $r->current_salary !== null ? Common::formatCurrency($r->current_salary) : 'N/A',
                'Proposed Salary'      => $r->proposed_salary !== null ? Common::formatCurrency($r->proposed_salary) : 'N/A',
