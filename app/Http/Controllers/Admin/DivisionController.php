...
use App\Exports\Admin\DivisionSampleExport;
use App\Imports\Admin\DivisionImport;
...
class DivisionController extends Controller
{
  ...
  {
      return Excel::download(new DivisionSampleExport, 'divisions-sample.xlsx');
  }
  ...
  public function import(Request $request)
  {
      ...
      $importer = new DivisionImport;
      Excel::import($importer, $request->file('file'));
      return response()->json([
          'success' => true,
          'msg'     => "Imported {$importer->created} division(s); skipped {$importer->skipped} duplicate(s).",
