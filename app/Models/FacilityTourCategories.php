...
class FacilityTourCategories extends Model
{
    use HasFactory;
    protected $table = 'facility_tour_categories';
    ...
    public function facilityTourImages() {
        return $this->hasMany(FacilityTourImages::class, 'facility_tour_category_id', 'id');
    }
