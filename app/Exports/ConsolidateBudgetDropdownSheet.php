...
class ConsolidateBudgetDropdownSheet implements FromArray, WithTitle, WithEvents, WithHeadings
{
        ...
        foreach ($divisions as $division) {
            ...
            foreach ($divisionDepartments as $department) {
                ...
                $posNames = $deptPositions->map(function($position) {
                    // Check if position has a code field
                ...
                // Store positions using department ID
                if (!empty($posNames)) {
