 ...
 * never re-derived later from the live ResortAdmin.signature_img, so the
 * transfer letter PDF keeps showing the exact signature used at the time
 * even if the approver later re-uploads a new one or leaves. Same naming
 * convention as employees_leaves_status's signature columns.
 */
